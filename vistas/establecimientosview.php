...
<body>
    <div class="container-fluid">
        ...
        include_once($_SERVER["DOCUMENT_ROOT"] . "/controladores/establecimientocontrolador.php");
        include_once($_SERVER["DOCUMENT_ROOT"] . "/controladores/destinocontrolador.php");
        include_once($_SERVER["DOCUMENT_ROOT"] . "/controladores/responsablecontrolador.php");
        $establecimientocontrolador = new establecimientocontrolador();
        $destinocontrolador = new destinocontrolador();
        $responsablecontrolador = new responsablecontrolador();
        if($_SERVER["REQUEST_METHOD"] == "POST") {       
            
            if($_POST['idestablecimientoval']>0){
                $establecimientocontrolador -> asignar($_POST['idestablecimientoval'],$_POST['idresponsable']);
                $_POST = array();
                header("location: establecimientosview.php");
